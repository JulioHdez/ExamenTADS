...
const browseFolder = () => {
  // En un entorno real, aquí se abriría un diálogo de selección de carpeta
  // Por ahora, simulamos con una ruta por defecto
  formData.destinationPath = 'C:\\Users\\Usuario\\Downloads\\Exportacion_Datos'
}
